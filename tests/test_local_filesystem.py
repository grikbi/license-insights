...
def test_list_files():
    ...
    test_data_dir = os.path.join(TESTS_DIR, "testdir1")
    localFileSystem = LocalFileSystem(test_data_dir)
    ...
    test_data_dir = os.path.join(TESTS_DIR, "testdir2")
    localFileSystem = LocalFileSystem(test_data_dir)
    # list of files must be empty
    assert not localFileSystem.list_files()

    # the testdir3 directory contains four JSON files
    test_data_dir = os.path.join(TESTS_DIR, "testdir3")
    localFileSystem = LocalFileSystem(test_data_dir)
...
def test_write_json_file():
    ...
    test_data_dir = os.path.join(TESTS_DIR, "testdir4")
    localFileSystem = LocalFileSystem(test_data_dir)
